...
class LearningAgent(Agent):
    ...
    def createQ(self, state):
        ...
        ## TO DO ##
        ###########
        # When check if the 'state' is not in the Q-table
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            list_maxQ = []
            for i in self.Q[state]:
                if self.Q[state][i] == max_Q:
                    list_maxQ.append(i)
            action = random.choice(list_maxQ)
...
def run():
    ...
    # Flags: verbose=True  - #set to True to display additional output from the simulation
    ...
    # Flags: learning  =True # - set to True to force the driving agent to use Q-learning
